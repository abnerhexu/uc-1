...
array_ll = np.array([1, 2, 3, 4], dtype='i8')
...
> 🍈已知曲线$  C_1:  $$\rho = \sin (3\theta )(0≤ \theta < 2\pi ) $，曲线\$ C\_2:  \$\$\begin{cases}\theta = t + \frac{\pi }{6}
> \ \rho = \sin ^2(\frac{6t}{5}-\frac{\pi}{5}) -\cos ^3(6t)
>
> \end{cases} (-\pi \le t < \pi)\$。将两个曲线通过子图的方式绘制在两幅极坐标图上，并使这两幅图片左右排列。
